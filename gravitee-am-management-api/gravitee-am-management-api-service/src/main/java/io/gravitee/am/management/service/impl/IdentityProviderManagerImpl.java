...
public class IdentityProviderManagerImpl implements IdentityProviderManager {
    ...
    public Single<IdentityProvider> create(String domain) {
        ...
        newIdentityProvider.setConfiguration("{\"uri\":\"" + mongoUri + "\",\"host\":\""+ mongoHost + "\",\"port\":" + mongoPort + ",\"enableCredentials\":false,\"database\":\"" + mongoDBName + "\",\"usersCollection\":\"idp_users_" + domain + "\",\"findUserByUsernameQuery\":\"{username: ?}\",\"passwordField\":\"password\",\"passwordEncoder\":\"BCrypt\"}");
